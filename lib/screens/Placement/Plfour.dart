...
import 'package:pfe_banking_system/screens/Placement/Plfive.dart';

class Plfour extends StatefulWidget {
  const Plfour({super.key});

  @override
  State<Plfour> createState() => _PlfourState();
}

class _PlfourState extends State<Plfour> {
  @override
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    InkWell(
                      onTap : (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Plfive()));
                      },
                      child: Container(
                        width: 300,
                        height: 50,
