...
class BudgetShopping extends StatefulWidget {
  const BudgetShopping({super.key});

  @override
  State<BudgetShopping> createState() => _BudgetShoppingState();
}

class _BudgetShoppingState extends State<BudgetShopping> {
        ...
        child: Form(
          ...
          children: [
            ...
            Padding(padding: EdgeInsets.only(left: 20,top: 20),child: Container(
              ...
              child: Padding(padding: EdgeInsets.only(top: 10,left: 20),child: Text("Shopping",style: TextStyle(
                  fontSize: 20
              ),),),
            ),),
            ...
            InkWell(
              onTap: () async{
                if(key.currentState!.validate()){
                  if(BudgetId == null){
                    Provider.of<MaxBudgetProvider>(context,listen: false).setType(type: "shopping");
                    ...
                    Provider.of<MaxBudgetProvider>(context,listen: false).updateMaxBudget("shopping", int.parse(montant.text));
                  }
                }
              },
              child: Container(
