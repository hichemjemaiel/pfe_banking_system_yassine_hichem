...
class BudgetEpargne extends StatefulWidget {
  const BudgetEpargne({super.key});

  @override
  State<BudgetEpargne> createState() => _BudgetEpargneState();
}

class _BudgetEpargneState extends State<BudgetEpargne> {
          ...
          child: Column(
            children: [
              ...
              Padding(padding: EdgeInsets.only(left: 20,top: 20),child: Container(
                ...
                child: Padding(padding: EdgeInsets.only(top: 10,left: 20),child: Text("Epargne",style: TextStyle(
                    fontSize: 20
                ),),),
              ),),
              ...
              InkWell(
                onTap: () async{
                  if(key.currentState!.validate()){
                    if(BudgetId == null){
                      Provider.of<MaxBudgetProvider>(context,listen: false).setType(type: "epargne");
                      ...
                      Provider.of<MaxBudgetProvider>(context,listen: false).updateMaxBudget("epargne", int.parse(montant.text));
                    }
                  }
                },
                child: Container(
