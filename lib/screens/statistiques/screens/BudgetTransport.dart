...
class BudgetTransport extends StatefulWidget {
  const BudgetTransport({super.key});

  @override
  State<BudgetTransport> createState() => _BudgetTransportState();
}

class _BudgetTransportState extends State<BudgetTransport> {
          ...
          child: Column(
            children: [
              ...
              Padding(padding: EdgeInsets.only(left: 20,top: 20),child: Container(
                ...
                child: Padding(padding: EdgeInsets.only(top: 10,left: 20),child: Text("Transport",style: TextStyle(
                    fontSize: 20
                ),),),
              ),),
              ...
              InkWell(
                onTap: () async{
                  if(key.currentState!.validate()){
                    if(BudgetId == null){
                      Provider.of<MaxBudgetProvider>(context,listen: false).setType(type: "transport");
                      ...
                      Provider.of<MaxBudgetProvider>(context,listen: false).updateMaxBudget("transport", int.parse(montant.text));
                    }
                  }
                },
                child: Container(
