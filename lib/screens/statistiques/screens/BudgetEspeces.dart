...
class BudgetEspeces extends StatefulWidget {
  const BudgetEspeces({super.key});

  @override
  State<BudgetEspeces> createState() => _BudgetEspecesState();
}

class _BudgetEspecesState extends State<BudgetEspeces> {
          ...
          child: Column(
            children: [
              ...
              Padding(padding: EdgeInsets.only(left: 20,top: 20),child: Container(
                ...
                child: Padding(padding: EdgeInsets.only(top: 10,left: 20),child: Text("Especes",style: TextStyle(
                    fontSize: 20
                ),),),
              ),),
              ...
              InkWell(
                onTap: () async{
                  if(key.currentState!.validate()){
                    if(BudgetId == null){
                      Provider.of<MaxBudgetProvider>(context,listen: false).setType(type: "especes");
                      ...
                      Provider.of<MaxBudgetProvider>(context,listen: false).updateMaxBudget("especes", int.parse(montant.text));
                    }
                  }
                },
                child: Container(
