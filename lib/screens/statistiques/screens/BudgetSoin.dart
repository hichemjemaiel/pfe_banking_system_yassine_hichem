...
class BudgetSoin extends StatefulWidget {
  const BudgetSoin({super.key});

  @override
  State<BudgetSoin> createState() => _BudgetSoinState();
}

class _BudgetSoinState extends State<BudgetSoin> {
          ...
          child: Column(
            children: [
              ...
              Padding(padding: EdgeInsets.only(left: 20,top: 20),child: Container(
                ...
                child: Padding(padding: EdgeInsets.only(top: 10,left: 20),child: Text("Soin",style: TextStyle(
                    fontSize: 20
                ),),),
              ),),
              ...
              InkWell(
                onTap: () async{
                  if(key.currentState!.validate()){
                    if(BudgetId == null){
                      Provider.of<MaxBudgetProvider>(context,listen: false).setType(type: "soin");
                      ...
                      Provider.of<MaxBudgetProvider>(context,listen: false).updateMaxBudget("soin", int.parse(montant.text));
                    }
                  }
                },
                child: Container(
