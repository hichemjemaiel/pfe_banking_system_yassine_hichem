...
class Codeverifautrebanque extends StatefulWidget {
  String montant;
  String senderRIB;
  String receiverRIB;
  String BankId;
  String namecreditnum;
   Codeverifautrebanque({super.key,required this.montant , required this.senderRIB , required this.receiverRIB , required this.BankId,required this.namecreditnum});

  @override
  State<Codeverifautrebanque> createState() => _CodeverifautrebanqueState();
}

class _CodeverifautrebanqueState extends State<Codeverifautrebanque> {
