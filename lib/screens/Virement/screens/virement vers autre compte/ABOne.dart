...
import 'package:pfe_banking_system/screens/Virement/screens/virement%20vers%20autre%20compte/CodeVerifAutrebanque.dart';
...
class Abone extends StatefulWidget {
  const Abone({super.key});

  @override
  State<Abone> createState() => _AboneState();
}

class _AboneState extends State<Abone> {
  int myIndex = 0;
  int ind = -1 ;
  int inde = -1;
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => Codeverifautrebanque(montant: montant,senderRIB: senderRIB,receiverRIB: receiverRIB,BankId: BankId,namecreditnum: namecreditnum,)));
                      },
                      child:  Container(
                        height: 40,
                        width: 150,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFFF2F2F2),
          title: Text("Virements vers autre banque"),
          centerTitle: true,
        ),
                      ...
                      onTap : (){
                        if(key.currentState!.validate()&& ind !=-1 && inde != -1){
                          if(accounts[ind].balance > int.parse(montant.text)){
                            showConfirmationDialog(context,montant.text,accounts[ind].RIB, accounts[inde].RIB,accounts[ind].id.toString(),namecreditnum.text);
                          }else{
