...
class Rfour extends StatefulWidget {
  const Rfour({super.key});

  @override
  State<Rfour> createState() => _RfourState();
}

class _RfourState extends State<Rfour> {
  int index =0;
  int myIndex = 0;
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Padding(padding: EdgeInsets.only(right: 220),child: Text("Derniers chiffres",style: TextStyle(
                      fontSize: 20
                  ),),),
                  SizedBox(height: 20,),
                  Container(
