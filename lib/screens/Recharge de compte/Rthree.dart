...
class Rthree extends StatefulWidget {
  const Rthree({super.key});

  @override
  State<Rthree> createState() => _RthreeState();
}

class _RthreeState extends State<Rthree> {
  int index =0;
  int myIndex = 0;
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Padding(padding: EdgeInsets.only(right: 180),child: Text("04 Derniers chiffres",style: TextStyle(
                      fontSize: 20
                  ),),),
                  SizedBox(height: 20,),
                  Container(
                      ...
                      child: Center(
                          child: TextField(
                            decoration: InputDecoration(
                                ...
                                hintText: "Saisir les 04 derniers chiffres"
                            ),
                          ))
