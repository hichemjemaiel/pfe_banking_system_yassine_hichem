...
class Creationentreprisersix extends StatefulWidget {
  String email;
   Creationentreprisersix({super.key, required  this.email});

  @override
  State<Creationentreprisersix> createState() => _CreationentreprisersixState();
}

class _CreationentreprisersixState extends State<Creationentreprisersix> {
  int index = -1;
                      ...
                      onTap: () {
                        if(selectedAgencyIndex != -1){
                          if(index ==0){
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context) => Creationentrepriseseven(agencyIndex: selectedAgencyIndex.toString(),email : widget.email)));
                          }else if(index ==1){
