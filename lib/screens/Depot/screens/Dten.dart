...
import 'package:pfe_banking_system/screens/Depot/screens/Deleven.dart';

class Dten extends StatefulWidget {
  const Dten({super.key});

  @override
  State<Dten> createState() => _DtenState();
}

class _DtenState extends State<Dten> {
  @override
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => Deleven()));
                    },
                    child: Container(
                      width: 300,
                      height: 70,
