      ...
      body: SingleChildScrollView(
        child:
            Column(
              children: [
                SizedBox(height: 40,),
                Text("         Veuillez entrer les informations du\nversement a effectuer sur votre compte SFE",style: TextStyle(
                    fontSize: 20
                ),),
                SizedBox(height: 50,),
               Stack(
                   ...
                   Container(
                     ...
                     child: Column(
                       children: [
                         ...
                         Text("Frais d'opération                                   Gratuit",style: TextStyle(
                           fontSize: 20
                         ),),
                         SizedBox(height: 30,),
                         Text("Montant a recevoir                      300 000 XAF",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                         SizedBox(height: 40,),
                         InkWell(
                           onTap: (){
                           ...
                           child: Container(
                             ...
                             child: Center(
                               child: Text("Valider",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25,color: Colors.white),),
                             ),
                           ),
                         )
                       ],
