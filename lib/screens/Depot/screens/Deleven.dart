...
import 'package:pfe_banking_system/screens/Depot/screens/Dtwelve.dart';

class Deleven extends StatefulWidget {
  const Deleven({super.key});

  @override
  State<Deleven> createState() => _DelevenState();
}

class _DelevenState extends State<Deleven> {
  @override
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Dtwelve()));
                        },
                        child: Container(
                          width: 200,
                          height: 70,
