...
class Creationparticulierseven extends StatefulWidget {
   String agencyIndex;
   String email;
   Creationparticulierseven({super.key, required this.agencyIndex, required this.email});

  @override
  State<Creationparticulierseven> createState() => _CreationparticuliersevenState();
}

class _CreationparticuliersevenState extends State<Creationparticulierseven> {
      ...
      body: Column(
        children: [
         ...
         Padding(padding: EdgeInsets.only(top: 10,left: 40),child: Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer a bibendum tellus. Suspendisse vitae orci quis felis tempor pellentesque sed id elit. Aenean mauris dui, iaculis nec ipsum in, ullamcorper ultrices sem. Sed nec consectetur nibh. Vivamus quam diam, vehicula ut feugiat congue, consectetur eu ante. Etiam vitae mattis est, sit amet scelerisque felis. In ullamcorper sapien nunc, et maximus lorem fringilla non.",style: TextStyle(
          ...
          Row(
            children: [
              Padding(padding: EdgeInsets.only(top: 30,left: 80),child: Container(
                decoration: BoxDecoration(
              ...
              InkWell(
                onTap: ()async{
                  if(isAccepted){
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Creationparticuliereight(agencyIndex : widget.agencyIndex,email:widget.email,otpCode : otpCode)));
                  }
